...
export function getCardPosition(stack, card) {
 const v=stack.findIndex(num=>num==card);
  return v;
}
...
export function isEachCardEven(stack) {
 const result= stack.every(num=>num%2==0);
  return result;
}
...
let res=stack.some(num=>num%2!==0);
  return res;
}
...
let num=  stack.findIndex(n=>n %2==0);
  return num;;
}
